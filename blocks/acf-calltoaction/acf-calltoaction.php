...
<section id="<?php echo get_field('section_id');?>" class="<?php echo get_field('achtergrond');?> <?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
    <div class="container  text-center">
        ...
        <a href="<?php echo $link_url; ?>" class="w-[240px] h-[45px] md:w-[240px] lg:w-[240px] lg:h-[58.5px] bg-[#07773C] duration-300 flex justify-center items-center text-19 leading-19 lg:text-25 lg:leading-25 font-tanker font-normal text-white mx-auto my-3" target="<?php echo $link_target; ?>"><?php echo $link_text; ?></a>
